...
namespace App\Modules\Finance\Actions\Concerns;
...
/**
 * Shared tenant guards for CRM actions. The global scope is a safety net; these
 * checks are the authoritative guarantee that an action never touches or
